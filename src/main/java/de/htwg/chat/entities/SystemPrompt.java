...
/**
 * Represents a system prompt that is sent to the llm.
 * The id is a UUID and will be autogenerated.
 * It uses the builder pattern to create a new system prompt.
 * It has a ManyToOne relationship with the Conversation class.
 *
 */
@Entity
